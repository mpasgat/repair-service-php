...
Q: Какой стек будем использовать?
A: PHP + Laravel (как в вакансии)

Q: Какой вариант запуска?
A: Docker Compose (предпочтительно)

Q: База данных?
A: SQLite (проще, без настройки)
```

## 2026-03-09 15:55:39 +03:00

```text
у меня есть арендованный виртуальный сервер, можешь настроить проект для дэплоя? айпи я доавблю, и также дай пж комманды, которые нужно будет ввести в терминале VPS